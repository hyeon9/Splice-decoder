...
def Run(key, input_gene_name, *sub_splicing):
    ...
    def Load_data(key, remove_info):
        ...
        query = query[["LongID","Simulated_event","AUG (Ref-Sim)","Stop (Ref-Sim)","CDS_difference","Reference_transcript","ORF","Domain_change_rate","Functional_class","Probability_of_NMD"]]
