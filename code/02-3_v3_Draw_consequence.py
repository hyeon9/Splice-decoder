...
def Run(key, input_gene_name, *sub_splicing):
    ...
    def Load_data(key, remove_info):
        ...
        query = query[["LongID","Simulated_event","AUG (Ref-Sim)","Stop (Ref-Sim)","Nucleotide_difference","Reference_transcript","ORF","Domain_change_rate","Functional_class","Probability_of_NMD"]]
                ...
                if len(domain) >= 2:
                    ...
                    if span[0] == 0:    # Consequence annotation
                        value_dict = {"PTC removal":"NMD",
                                      ...
                                      "LoD":"GoD",
                                      "GoD":"LoD",
                                      "other_regions_diff":"other_regions_diff",
