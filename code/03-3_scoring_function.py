...
def Multi_splicing_prop(score_df, stype, mode):
    ...
    final_df = final_df[["LongID","gene","ref_tx","event","Effect_Score","change_rate","pNMD","DOA_direction","dPSI_2_minus_1","TU","ORF","Start","Stop","dAA","5'UTR","3'UTR","Domain_integrity","Sim_Domain","Ref_Domain","-log10(q)"]]
    ...
    final_df.columns = ["LongID","gene","Reference_transcript","Simulated_event","Effect_Score","Domain_change_rate","Probability_of_NMD","Functional_class","Delta_PSI","Transcript_usage","ORF","AUG (Ref-Sim)","Stop_codon (Ref-Sim)","Nucleotide_difference","5'UTR_difference","3'UTR_difference","Domain_integrity","Length_of_simulated_tx_domain","Length_of_referece_tx_domain","rMATS_FDR(-log10)"]
