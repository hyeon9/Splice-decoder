...
def Multi_splicing_prop(score_df, stype, mode):
    ...
    final_df = final_df[["LongID","gene","ref_tx","event","Effect_Score","FS","pNMD","Functional_class","dPSI_2_minus_1","TU","ORF","Start","Stop","dAA","5'UTR","3'UTR","Domain_integrity","Sim_Domain","Ref_Domain","-log10(q)"]]
