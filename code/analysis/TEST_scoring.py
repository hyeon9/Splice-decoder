...
def Multi_splicing_prop(score_df, stype, mode):
        ...
        if sub_sid.shape[0] > 0:
            for sub_class in sub_sid["event"].unique():    # Inclusion or Skipping
                ...
                for tx in each_SP["ref_tx"].unique():   # Calculate Effect_Score per TX in each DS
                    ...
                    ind_SP["Max_PSI"] = Ps # Updated 25.05.07
    ...
    final_df = final_df[["LongID","gene","ref_tx","event","Effect_Score","FS","pNMD","DOA_direction","dPSI_2_minus_1","TU","ORF","Start","Stop","dAA","5'UTR","3'UTR","Domain_integrity","Sim_Domain","Ref_Domain","-log10(q)","Max_PSI"]]
