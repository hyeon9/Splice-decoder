...
Description
    ...
    parser.add_argument('--input', '-i', 
                        ...
                        required=False,
                        type=str,
                        default="/home/kangh/lab-server/Tool/Splice-decoder/example/MYC_8h/")
...
def Make_int(input_df):
    ...
    Returns:
        _type_: merged_df
    """
    rmat = pd.read_csv("/home/kangh/lab-server/Tool/Splice-decoder/example/MYC_8h/rmat.csv",
                       sep=",")
...
def Make_TPM():
    path = "/home/kangh/lab-server/Tool/Splice-decoder_git/example/MYC8h/tpm/" # TPM folder
...
def Add_TU(tpm, query_df):
    ...
    if len(tu_check) > 0:
        ...
        with open("/home/kangh/lab-server/Tool/Splice-decoder_git/example/MYC8h/main.gtf", "r") as main_gtf:
            print("Checking GTF...\n\n")
            gene_tx = {}
        ...
        output_path = "/home/kangh/lab-server/Tool/Splice-decoder/example/MYC_8h/tpm/TU.txt"
...
def Multi_splicing_prop(score_df, stype, mode):
    ...
    """
    try:
        os.remove("/home/kangh/lab-server/Tool/Splice-decoder_git/example/MYC8h/result/Classified_DS_{}.txt".format(stype))
        os.remove("/home/kangh/lab-server/Tool/Splice-decoder_git/example/MYC8h/result/Whole_DS_score_{}.txt".format(stype))
    except:
        pass
    ...
    if mode == "N":
        ...
        tu = pd.read_csv("/home/kangh/lab-server/Tool/Splice-decoder/example/MYC_8h/tpm/TU.txt",
                         sep="\t",
                         index_col="0")
    ...
    for sid in score_df["LongID"].unique():    # Per each splicing
        ...
        sub_sid = pd.merge(sub_sid, tu, left_on="ref_tx", right_index=True) # Add TU columns
    ...
    final_df.to_csv("/home/kangh/lab-server/Tool/Splice-decoder/example/MYC_8h/result/250530_Whole_DS_score_{}.txt".format(stype),
                    sep="\t",
                    index=False)


ref_result = pd.read_csv("/home/kangh/lab-server/Tool/Splice-decoder/example/MYC_8h/result/merged_input_for_eval.txt",
...
# %%
## dAA needs some normalized scale
...
Multi_splicing_prop(merged_df,"Whole","Y_own") 
