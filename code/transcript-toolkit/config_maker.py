...
config['canonical'] = questionary.text("Specify a strategy to define canonical transcripts (it can bed default or user").ask()
config['gene_list'] = questionary.text("Enter your gene_list. If you set --canonical as 'user', your gene_list must contain gene and canonical transcript IDs (tab separated)\n(e.g. /User/usr/Tool/Splice-decoder-main/toy_data/gene_list.txt))").ask()
